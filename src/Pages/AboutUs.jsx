  ...
  return (
    <section className="bg-white py-24 px-6">
      <div className="max-w-7xl mx-auto space-y-28">
        ...
        {/* 👤 FOUNDER QUOTE */}
        <div className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white p-10 rounded-3xl grid md:grid-cols-2 gap-10 items-center">
          <img src={FounderImg} alt="Founder Gowrishankar" className="rounded-2xl shadow-lg" />
          <div>
            <p className="italic text-lg mb-4">
              “Technology should empower people and transform businesses.”
            </p>
            <h3 className="text-xl font-semibold">Mr. Gowrishankar</h3>
